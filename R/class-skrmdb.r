...
#'   object
#'
#' @description `r badge("deprecated")` This is an accessor function for
#'   retrieving the numeric value of the effective median dose from a
#'   [skrmdb-class] object object generated by `ReedMuench`, `SpearKarb`, or
#'   `DragBehr`.
#'
...
#' effective median dose from a [skrmdb-class] object object generated by
...
#' from a [skrmdb-class] object object generated by `ReedMuench`, `SpearKarb`,
#' or `DragBehr`.
#'
#' @param x class skrmdb.
