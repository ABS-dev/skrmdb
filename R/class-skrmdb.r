...
#' 
#' This is an accessor function for retrieving the numeric value of the effective 
#' median dose from a \code{\link{skrmdb-class}} object object generated by \code{ReedMuench}, 
#' \code{SpearKarb}, or \code{DragBehr}.
#' 
...
#' from a \code{\link{skrmdb-class}} object object generated by \code{ReedMuench}, 
#' \code{SpearKarb}, or \code{DragBehr}.
#' 
#' @param x class skrmdb.
...
#' 
#' This is an accessor function for retrieving the data used to compute the effective 
#' median dose from a \code{\link{skrmdb-class}} object object generated by \code{ReedMuench}, 
#' \code{SpearKarb}, or \code{DragBehr}.
#' 
#' @param x class skrmdb.
...
#' @param data The data used to compute the effective median dose. data.frame, numeric.
#' @param message Messages and warnings generated durning the calculation. character string.
#' 
#' @name skrmdb-class
NULL
